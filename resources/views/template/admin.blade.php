...
<head>
    ...
    <title>Website Sistem Informasi Pengelolaan Data Warga Desa Tumuk Manggis</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/dashboard" class="brand-link" style="text-decoration: none">
                <img src="{{ asset('gambar/Logo-Kab-Sambas.png') }}" alt="AdminLTE Logo" class="brand-image"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">Desa Tumuk Manggis</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/anggotakeluar" class="nav-link">
        ...
        <center>
            <footer class="main-footer">
                <strong>Copyright &copy; {{ date('Y') }} <a href="#">Desa Tumuk Manggis</a>.</strong>
                Aldi Renadi.
            </footer>
        </center>
    </div>
