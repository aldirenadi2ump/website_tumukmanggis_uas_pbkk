                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{-- @if (auth()->user()->role == 'admin')
                            <a href="/addwarga" type="button" class="btn btn-success">Tambah Data</a>
                        @endif --}}
                                        ...
                                        <tbody>
                                            @foreach ($data as $index => $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('foto_warga/' . $value->foto_warga) }}"
                                                            style="width: 100px;">
                                                    </td>
                                                    <td>{{ $value->akun->role }}</td>
                                                    @if (auth()->user()->role == 'admin')
                                                        <td>
                                                            <a href="/tampilkandata/warga/{{ $value->id_user }}"
                                                                class="btn btn-warning">Ubah</a>
                                                            <a href="#" class="btn btn-danger delete"
                                                                data-id="{{ $value->id }}"
                                                                data-nama="{{ $value->name }}">Hapus</a>
                                                        </td>
                                                    @endif
                                                </tr>
                                            @endforeach
        ...
        <script>
            $('.delete').click(function() {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            window.location = "/delete/" + akikahid + ""
