...
@section('content')
    <div class="content-wrapper">
        ...
        <body>
            ...
            <h1 class="text-center mb-5 mt-5">Tambah Data Pernikahan</h1>
            ...
            <div class="row ml-2 mr-2">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/insertdata/pernikahan" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="alamat_pria" rows="3" placeholder="Enter ..."></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Alamat</label>
                                    <textarea class="form-control" name="alamat_wanita" rows="3" placeholder="Enter ..."></textarea>
                                </div>
                                ...
                                <h2 class="text-center">Tanggal dan Tempat </h2>
