                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @if (auth()->user()->role == 'admin')
                            <a href="/addkematian" type="button" class="btn btn-success">Tambah Data</a>
                        @endif
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $index => $value)
                                                <tr>
                                                    ...
                                                    <td>{{ $value->akta_kematian }}</td>
                                                    <td>{{ $value->nama_lengkap }}</td>
                                                    <td>{{ $value->tempat_lahir }}</td>
                                                    <td>{{ $value->tanggal_lahir }}</td>
                                                    <td>{{ $value->jeniskelamin }}</td>
                                                    <td>{{ $value->tempat_kematian }}</td>
                                                    {{-- <td>{{ $value->anak_ke }}</td> --}}
                                                    ...
                                                    @if (auth()->user()->role == 'admin')
                                                        <td>
                                                            <a href="/tampilkandata/kematian/{{ $value->id }}"
                                                                class="btn btn-warning">Ubah</a>
                                                            <a href="#" class="btn btn-danger delete"
                                                                data-id="{{ $value->id }}"
                                                                data-nama="{{ $value->nama_lengkap }}">Hapus</a>
                                                        </td>
                                                    @endif
                                                </tr>
                                            @endforeach
        ...
        <script>
            $('.delete').click(function() {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            window.location = "/delete/kematian/" + akikahid + ""
